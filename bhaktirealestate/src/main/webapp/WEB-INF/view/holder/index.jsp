										...
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
													<button class="kt-aside__brand-aside-toggler btn btn-clean btn-bold btn-upper" id="kt_aside_toggler">
											...
											<div class="kt-portlet__head-toolbar">
												<a href="#" class="btn btn-icon" data-toggle="modal" data-target="#kt_modal_5">
