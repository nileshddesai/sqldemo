										...
										<div class="kt-portlet__head">
											<div class="kt-portlet__head-label">
												<h3 class="kt-portlet__head-title">
													<a class="btn btn-clean btn-bold btn-upper" href="<%=request.getContextPath()%>/home">
													...
													<span>Property Category 1</span>
												</h3>
											</div>
											<div class="kt-portlet__head-toolbar">
												<a href="#" class="btn btn-icon" data-toggle="modal" data-target="#holder_new_modal">
																...
																<div class="kt-widget kt-widget--user-profile-2 kt-margin-t-50">
																	<div class="kt-widget__head">
																		<div class="kt-widget__info kt-padding-l-0">
																			<a href="#" class="kt-widget__username" data-toggle="modal" data-target="#holder_edit_modal">
																				Luca Doncic
																			</a>
																		...
																		<span class="kt-widget__status kt-font-info kt-font-success">
																	...
																	<div class="kt-widget__body">
																		<div class="kt-widget__item">
																			<div class="kt-widget__contact" style="display: block;">
																				...
																				<a href="#" class="kt-widget__data">9714866160</a>
																			</div>
																			<div class="kt-widget__contact" style="display: block;">
																				<span class="kt-widget__label">Size:</span>
																				<a href="#" class="kt-widget__data">17/85</a>
																			</div>
																			<div class="kt-widget__contact" style="display: block;">
																				<span class="kt-widget__label">Price:</span>
																				<span class="kt-widget__data">1200</span>
																			</div>
																		</div>
																	</div>
																</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<button type="button" class="btn btn-danger btn-sm btn-icon"><i class="fa fa-trash"></i></button>
					</div>
					<div class="modal-body">
						<form>
							<div class="form-group">
