									...
									<div class="kt-portlet kt-portlet--height-fluid">
										<div class="kt-portlet__head">
											...
											<div class="kt-portlet__head-toolbar">
												<a href="#" class="btn btn-icon" data-toggle="modal" data-target="#property_category_new_modal">
												...
												<div class="tab-pane active" id="kt_widget6_tab1_content" aria-expanded="true">
													<div class="kt-widget4">
														...
														<div class="kt-widget4__item">
															...
															<button type="button" class="btn btn-secondary btn-icon" data-toggle="modal" data-target="#property_category_edit_modal"><i class="fa fa-eye"></i></button>					 
														</div>
														<div class="kt-widget4__item">
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username font-size-1_2rem">
															...
															<button type="button" class="btn btn-secondary btn-icon"><i class="fa fa-eye"></i></button>					 
														</div>
														<div class="kt-widget4__item">
															<div class="kt-widget4__info">
																<a href="#" class="kt-widget4__username font-size-1_2rem">
